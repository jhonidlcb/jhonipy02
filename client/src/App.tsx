...
import CarlosAntonioLopez from "@/pages/seo/CarlosAntonioLopez";
import MayorOtano from "@/pages/seo/MayorOtano";
import SoftwareItapua from "@/pages/seo/SoftwareItapua";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      {/* SEO Landings */}
      <Route path="/desarrollo-web-carlos-antonio-lopez" component={CarlosAntonioLopez} />
      <Route path="/sistemas-en-mayor-otano" component={MayorOtano} />
      <Route path="/software-en-itapua" component={SoftwareItapua} />
