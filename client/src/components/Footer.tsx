...
<div>
              <h4 className="font-semibold mb-4">Zonas de Servicio</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <a href="/desarrollo-web-carlos-antonio-lopez" className="hover:text-primary transition-colors">
                    Carlos Antonio López
                  </a>
                </li>
                <li>
                  <a href="/sistemas-en-mayor-otano" className="hover:text-primary transition-colors">
                    Mayor Otaño
                  </a>
                </li>
                <li>
                  <a href="/software-en-itapua" className="hover:text-primary transition-colors">
                    Itapúa (General)
                  </a>
                </li>
              </ul>
