  ...
  return (
    <Layout onAuthClick={openAuthModal}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="font-sans text-3xl sm:text-4xl font-bold text-foreground mb-4 tracking-tight">
              Servicios de Desarrollo de Software en Itapúa
            </h2>
      ...
      {/* Footer */}
        ...
        {/* New SEO Section - Atendemos Empresas y Consultorios en Itapúa */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/5">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6">Atendemos Empresas y Consultorios en Itapúa</h2>
            <p className="text-lg text-muted-foreground mb-8">
              Brindamos servicios de desarrollo web, sistemas de turnos online y digitalización empresarial en Carlos Antonio López, Mayor Otaño y todo el departamento de Itapúa. Ofrecemos soporte profesional y acompañamiento continuo.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left max-w-2xl mx-auto mb-10">
              <div className="flex items-center gap-2">
                <CheckCircle className="text-primary h-5 w-5" />
                <span><a href="/desarrollo-web-carlos-antonio-lopez" className="hover:text-primary transition-colors font-medium">Desarrollo web en Carlos Antonio López</a></span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="text-primary h-5 w-5" />
                <span><a href="/sistemas-en-mayor-otano" className="hover:text-primary transition-colors font-medium">Sistemas de turnos online en Mayor Otaño</a></span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="text-primary h-5 w-5" />
                <span><a href="/software-en-itapua" className="hover:text-primary transition-colors font-medium">Software empresarial en Itapúa</a></span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="text-primary h-5 w-5" />
                <span>Soporte técnico y mantenimiento continuo</span>
              </div>
            </div>
            <Button size="lg" onClick={handleWhatsAppContact} className="bg-[#25D366] hover:bg-[#128C7E] text-white">
